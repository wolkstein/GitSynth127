//0, Expression Pedal Function CTR, 0-127 // dies wird vom expression pedal ausgeschlossen
//1, Function Footswitch CTR, 0-127 ?? kommt noch je nach funktionen
//2, Analog Circuit Instrument Gain, 0-127 // ist jetzt analog!
//3, Analog Circuit Instrument Mix, 0-127

//4, Mixer Instrument Input To Synth Frequency - and Envelope - tracking, 0-127
//5, Mixer Usb Input 1 To Synth Frequency - and Envelope - tracking, 0-127
//6, Mixer Synth To Output 1, 0-127
//7, Mixer Synth To Output 2, 0-127
//8, Mixer Synth To Usb Output 1, 0-127
//9, Mixer Synth To Usb Output 2, 0-127
//10, Mixer Instrument To Usb-OutPut 1, 0-127
//11, Mixer Instrument To Usb-OutPut 2, 0-127
//12, Mixer Usb Input 1 To Output 1, 0-127
//13, Mixer Usb Input 1 To Output 2, 0-127
//14, Mixer Usb Input 2 To Output 1, 0-127
//15, Mixer Usb Input 2 To Output 2, 0-127
//16, Filter 1 Dynamic Filter Frequency Target, 0 - 4
//17, Filter 2 Dynamic Filter Frequency Target, 0 - 4
//18, Filter Lfo Cycles, 0-127
//19, Mod Lfo cycles, 0-127
//20, OSC Main Volumen, 0-127
//21, Filter 1 Freq, 0-127
//22, Filter 1 Resonance, 0-127
//23, Filter 1 Octave74, 0-127
//24, Filter 2 Freq, 0-127
//25, Filter 2 Resonance, 0-127
//26, Filter 2 Octave, 0-127
//27, Filter 2 Type, 1-3
//28, Filter 1<->2 Blend, 0-127
//29, Filter 1<->2 Crossover Mod, 0-1
//30, Guitar Envelope Sensing Attack, 0-127
//31, Guitar Envelope Sensing release, 0-127
//32, Guitar Sense Note Off Corner, 0-127
//33, Guitar Sense Pitch detection treshold, 0-127
//34, Guitar Sense Pitch detection Quality, 0-127
//35, OSC1 Volumen, 0-127
//36, OSC1 WaveForm, 0-15
//37, OSC1 PulseWidth, 0-127
//38, OSC1 Octave, 0-8
//39, OSC1 Note, 0-24
//40, OSC1 CENTS, 0-24
//41, OSC1 Phase, 0-127
//42, OSC2 Volumen, 0-127
//43, OSC2 WaveForm, 0-5
//44, OSC2 PulseWidth, 0-127
//45, OSC2 Octave, 0-8
//46, OSC2 Note, 0-24
//47, OSC2 CENTS, 0-24
//48, OSC2 Phase, 0-127
//49, Sub-OSC1 Volumen, 0-127
//50, Sub-OSC1 WaveForm, 0-5
//51, Sub-OSC1 PulseWidth, 0-127
//52, Sub-OSC1 Octave, 0-8
//53, Sub-OSC1 Note, 0-24
//54, Sub-OSC1 CENTS, 0-24
//55, Sub-OSC1 Phase, 0-127
//56, Sub-OSC2 Volumen, 0-127
//57, Sub-OSC2 WaveForm, 0-5
//58, Sub-OSC2 PulseWidth, 0-127
//59, Sub-OSC2 Octave, 0-8
//60, Sub-OSC2 Note, 0-24
//61, Sub-OSC2 CENTS, 0-24
//62, Sub-OSC2 Phase, 0-127
//63, Noise Level, 0-127
//64, Bit crusher Volumen, 0-127
//65, Bit Crusher Bits, 0-15
//66, Bit crusher Sample Rate, 0-6
//67, Filter-LFO WaveForm, 0-5
//68, Filter-LFO PulseWide, 0-127
//69, Filter-LFO BPM, 0-127
//70, Filter-LFO BPM Multip., 0-20
//71, Filter-LFO Phase, 0-127
//72, Filter-LFO Sync To Attack, 0-1
//73, Filter-LFO Depth, 0-127
//74, Filter-LFO envelope Attack to Frequency ++, 0-127
//75, Filter-LFO envelope Attack to Depth, 0-127
//76, Envelope Attack to Filter Cutoff, 0-127
//77, Guitar Use Filter DAHDSR, 0-1
//78, Guitar use Envelope AHDSR, 0-1
//79, Envelope AHDSR-Attack, 0-127
//80, Envelope AHDSR-Hold, 0-127
//81, Envelope AHDSR-Decay, 0-127
//82, Envelope AHDSR-Sustain, 0-100
//83, Envelope AHDSR-Release, 0-127
//84, Filter AHDSR-Delay, 0-127
//85, Filter AHDSR-Attack, 0-127
//86, Filter AHDSR-Hold, 0-127
//87, Filter AHDSR-Decay, 0-127
//88, Filter AHDSR-Sustain, 0-100
//89, Filter AHDSR-Release, 0-127
//90, Modulation LFO Waveform, 0-127
//91, Modulation Lfo Pulsewidth, 0-127
//92, Modulation Lfo BPM, 0-127
//93, Modulation Lfo BPM Multip., 0-20
//94, Modulation Lfo Phase, 0-127
//95, Modulation Lfo Sync To Attack, 0-1
//96, Modulation Lfo envelope Attack to Frequency ++, 0-127
//97, Modulation Lfo envelope Attack to Depth, 0-127
//98, Guitar use Static Filter Envelope, 0-127
//99, Modulation Lfo Frequency Target OSC1, 0-127
//100, Modulation Lfo Frequency Target OSC2, 0-127
//101, Modulation Lfo Frequency Target Sub OSC1, 0-127
//102, Modulation Lfo Frequency Target Sub OSC2, 0-127
//103, Modulation Lfo Frequency Target 1-4 Sync, 0-1
//104, Modulation Lfo Pulsewidth Target 1-4 Sync, 0-1
//105, Modulation Lfo Pulsewidth Target OSC1, 0-127
//106, Modulation Lfo Pulsewidth Target OSC2, 0-127
//107, Modulation Lfo Pulsewidth Target Sub OSC1, 0-127
//108, Modulation Lfo Pulsewidth Target Sub OSC2, 0-127
//109, Volumen LFO Waveform, 0-127
//110, Volumen Lfo Pulsewidth, 0-127
//111, Volumen Lfo BPM, 0-127
//112, Volumen Lfo BPM Multip., 0-20
//113, Volumen Lfo Phase, 0-127
//114, Volumen Lfo Sync To Attack, 0-1
//115, Volumen Lfo envelope Attack to Frequency ++, 0-127
//116, Volumen Lfo envelope Attack to Depth, 0-127
//117, Volumen Lfo Target 1-4 Sync, 0-1
//118, Volumen Lfo Target OSC1, 0-127
//119, Volumen Lfo Target OSC2, 0-127
//120, Volumen Lfo Target Sub OSC1, 0-127
//121, Volumen Lfo Target Sub OSC2, 0-127
//122, Midi Pitchband Range, 0-23
//123, Auto Peak Correction, 0-1
//124, Master Clock To all Lfos, 0-1
//125, Master Clock To MOD Lfo, 0-1
//126, Master Clock To VOL Lfo, 0-1
//127, Master Clock To Freq LFO, 0-1

/*
 const char* expPedalFunctionLookup[20] =
{
    "OFF           ",
    "F1 CutOff     ", 21
    "F1 Reso       ", 22
...
//    break;
    ...
    case 16: // D-F-F Filter1
        if(value > 4){ 
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter 1 D-F-F to high value: %d\n",value);
        }
        else
        { 
    ...
    case 17: // D-F-F Filter2
        if(value > 4){ 
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter 2 D-F-F to high value: %d\n",value);
        }
        else
        { 
    ...
    case 21: // controll 21 = filter frequency
        ...
        if(mySettings.Filter1_Active_Frequenz_Tracking_Target>0){
          ...
          if(DEBUG_EXPRESSION_PEDAL){
            Serial.printf("Control Filter1 change Cutoff D-F-F Frequency offset now to OSC Frequency %f \n", G_Filter1_Active_Frequenz_Tracking);
          }          
    ...
    case 24: // controll 24 = filter2 frequency
         if(mySettings.Filter2_Active_Frequenz_Tracking_Target>0){
          ...
          if(DEBUG_EXPRESSION_PEDAL){
            Serial.printf("Control Filter2 Cutoff  D-F-F Frequency offset changing now to %f \n", G_Filter2_Active_Frequenz_Tracking);
          }          
    ...
    case 27:
        ...
        if(value<1 || value >3){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter2 Mode to low or to high value: %d\n",value);
        }
        else
        {
          mySettings.filter2Mode = value;
          calculateFilterMixer();
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter2 Mode set to: %d\n",value);
        }
    ...
    case 28: // filter 1 2 blend
        ...
        calculateFilterMixer();
        if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter 1-2 Mixer set to: %f| and back to midi: %d\n",loghelperValFloat, map(int(loghelperValFloat*1000.0)+5,-500,500,0,127));
        
    break;

    case 29: // filter 1 2 crossover envlope
        if(value >1){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter1-2  crossover Mod to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter1-2 Crossover Mod is set to: %f\n",mySettings.f1_f2_crossover_Modulation);
        }       
    break;
    ...
    case 31: // filter 1 2 guitarsensing release
        ...
        if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Git Sensing Release %d | und zuruck: %d\n",mySettings.sensingFall , map(mySettings.sensingFall+5,0,1000,0,127));
    ...
    case 36: // OSC1 WaveForm
        ...
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC2 WaveForm set to: %d\n",value);
        }
    ...
    case 38: // OSC 1 Octave
        if(value > 8){ // OSC 1 Octave
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC1 Octave to high value: %d\n",value);
        }
        else
        {     
    ...
    case 39: // OSC 1 Note
        if(value > 24){ // OSC 1 Note
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC1 Note to high value: %d\n",value);
        }
        else
        {     
    ...
    case 40: // OSC 1 Cents
        if(value > 24){ // OSC 1 Detune cents
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC1 Detune to high value: %d\n",value);
        }
        else
        {     
    ...
    case 43: // OSC2 WaveForm
        ...
        if(value >5){ // OSC 2 
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC2 WaveForm to high value: %d\n",value);
        }
        else
        {
    ...
    case 45: // OSC 2 Octave
        if(value > 8){ // OSC 1 Octave
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC2 Octave to high value: %d\n",value);
        }
        else
        {     
    ...
    case 46: // OSC 2 Note
        if(value > 24){ // OSC 1 Note
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC2 Note to high value: %d\n",value);
        }
        else
        {     
    ...
    case 47: // OSC 2 Cents
        if(value > 24){ // OSC 1 Detune cents
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("OSC2 Detune to high value: %d\n",value);
        }
        else
        {     
    ...
    case 50: // SUB_OSC1 WaveForm
        ...
        if(value >15){ // SUB_OSC 1 + 10 abetarys
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC1 WaveForm to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SubOSC2 WaveForm set to: %d\n",value);
        }
    ...
    case 52: // SUB_OSC 1 Octave
        if(value > 8){ // SUB_OSC 1 Octave
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC1 Octave to high value: %d\n",value);
        }
        else
        {     
    ...
    case 53: // SUB_OSC 1 Note
        if(value > 24){ // SUB_OSC 1 Note
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC1 Note to high value: %d\n",value);
        }
        else
        {     
    ...
    case 54: // SUB_OSC 1 Cents
        if(value > 24){ // SUB_OSC 1 Detune cents
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC1 Detune to high value: %d\n",value);
        }
        else
        {     
    ...
    case 57: // SUB_OSC2 WaveForm
        ...
        if(value >5){ // SUB_OSC 2 
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC2 WaveForm to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Sub Osc2 WaveForm set to: %d\n",value);
        }
    ...
    case 59: // SUB_OSC 2 Octave
        if(value > 8){ // SUB_OSC 1 Octave
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC2 Octave to high value: %d\n",value);
        }
        else
        {     
    ...
    case 60: // SUB_OSC 2 Note
        if(value > 24){ // SUB_OSC 1 Note
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC2 Note to high value: %d\n",value);
        }
        else
        {     
    ...
    case 61: // SUB_OSC 2 Cents
        if(value > 24){ // SUB_OSC 1 Detune cents
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("SUB_OSC2 Detune to high value: %d\n",value);
        }
        else
        {     
    ...
    case 65: // Bit Crusher Bits
        if(value > 15){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Bit Crusher Bits to high value: %d\n",value);
        }
        else
        {          
    ...
    case 66: // Bit Crusher Rate
        if(value > 6){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Bit Crusher Sample rate to high value: %d\n",value);
        }
        else
        {  
    ...
    case 67: // Filter WaveForm
        ...
        if(value >11){ // 
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter LFO WaveForm to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter LFO WaveForm set to: %d\n",value);
        }
   ...
   case 69: // Filter Lfo Bpm
        ...
        if(mySettings.MasterClockToLfos || mySettings.MasterclockToFreqLFO){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter BPM on CLOCK SYNC! BREAK\n"); 
          break;
        }
        ...
        if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter LFO BPM set to: %f| und zuruck: %d\n", mySettings.filter_lfo_bpm, map(mySettings.filter_lfo_bpm + 2,0,360,0,127));    
   ...
   case 70: // Filter Lfo Bpm multip
        ...
        if(value >20){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter LFO BPM Multiplier to high value: %d\n",value);
        }
        else
        {
   ...
   break;
    ...
    break;
     ...
     case 72: // Filter lfo sync to attack
        ...
        if(value >1){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter LFO Sync To Attack to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Filter LFO Sync to Attack is set to: %d\n",mySettings.filter_lfo_attack_sync);
        }
     break;
     ...
     case 77: // gittare use filteradsr
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Guitar use Filter DAHDSR to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Guitar use Filter DAHDSR is set to: %d\n",mySettings.gitarUseFilterADSR);
          }
     break;
   
     case 78:      // gittare use envelop adsr
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Guitar use Envelop AHDSR to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Guitar use Envelope AHDSR is set to: %d\n",mySettings.gitarUseEnvelopeADSR);
          }
     break;
    ...
    case 82: // envelope sustain
        if(value >100){
         if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Envelop AHDSR Sustain to high value: %d\n",value);
        }
        else
        {       
    ...
    case 88: // ADSR Filter sustain
        if(value >100){
         if(DEBUG_EXPRESSION_PEDAL) Serial.printf(" AHDSR Filter Sustain to high value: %d\n",value);
        }
        else
        {       
    ...
    case 90: // Mod Lfo WaveForm
        ...
        if(value >11){ // SUB_OSC 2 
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Mod LFO WaveForm to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Mod LFO WaveForm set to: %d\n",value);
        }
   ...
   case 92: // Mod Lfo Bpm
        ...
        if(mySettings.MasterClockToLfos || mySettings.MasterClockToMODLfo){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Mod Lfo BPM on CLOCK SYNC! BREAK\n"); 
          break;
        }
        ...
        if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Mod LFO BPM set to: %f| und zuruck: %d\n", mySettings.mod_lfo_bpm, map(mySettings.mod_lfo_bpm + 2,0,360,0,127));    
   ...
   case 93: // Mod Lfo Bpm multip
        ...
        if(value >20){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Mod LFO BPM Multiplier to high value: %d\n",value);
        }
        else
        {
   ...
   break;
    ...
    break;
     ...
     case 95: // Mod lfo sync to attack
        ...
        if(value >1){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Mod LFO Sync To Attack to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Mod LFO Sync to Attack is set to: %d\n",mySettings.mod_lfo_attack_sync);
        }
     break;
     ...
     case 103: // MOD lfo Intensity T1 - T4 Sync
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("MOD lfo Intensity T1 - T4 Sync to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("MOD lfo Intensity T1 - T4 Sync is set to: %d\n",mySettings.mod_lfo_T1_T4_FREQ_intensety_sync);
          }
     ...
     case 104: // MOD lfo Intensity T5 - T8 Sync
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("MOD lfo Intensity T5 - T8 Sync to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("MOD lfo Intensity T5 - T8 Sync is set to: %d\n",mySettings.mod_lfo_T1_T4_PULSE_intensety_sync);
          }
   ...
   // ###########################################  Vol LFO ####################################################
    ...
    case 109: // Vol Lfo WaveForm
        ...
        if(value >11){ // SUB_OSC 2 
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol LFO WaveForm to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol LFO WaveForm set to: %d\n",value);
        }
   ...
   case 111: // Vol Lfo Bpm
        ...
        if(mySettings.MasterClockToLfos || mySettings.MasterClockToVOLLfo){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol BPM on CLOCK SYNC! BREAK\n"); 
          break;
        }
        ...
        if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol LFO BPM set to: %f| und zuruck: %d\n", mySettings.vol_lfo_bpm, map(mySettings.vol_lfo_bpm + 2,0,360,0,127));    
   ...
   case 112: // Vol Lfo Bpm multip
        ...
        if(value >20){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol LFO BPM Multiplier to high value: %d\n",value);
        }
        else
        {
   ...
   break;
    ...
    break;
     ...
     case 114: // Vol lfo sync to attack
        ...
        if(value >1){
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol LFO Sync To Attack to high value: %d\n",value);
        }
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol LFO Sync to Attack is set to: %d\n",mySettings.vol_lfo_attack_sync);
        }
     break;
     ...
     case 117: // Vol lfo Intensity T1 - T1 Sync
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol lfo Intensity T1 - T4 Sync to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Vol lfo Intensity T1 - T4 Sync is set to: %d\n",mySettings.vol_lfo_T1_T4_intensety_sync);
          }
     ...
     case 122: // Midi Pitchband range
        ...
        else
        {
          ...
          if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Midi Pitch Band Range set to: %d\n", mySettings.midi_pichbandrange  );
        }    
     ...
     case 123: // Peak Auto Correction
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Peak Auto correction to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Peak Auto correction is set to: %d\n",mySettings.autoPeakCorrection);
          }
     break;
     ...
     case 124: // Master Clock To All LFOs
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Master Clock To All LFOs to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Master Clock To All LFOs is set to: %d\n",mySettings.MasterClockToLfos);
          }
     break;
     ...
     case 125: // Master Clock To MOD LFO
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Master Clock To MOD LFO to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Master Clock To MOD LFO is set to: %d\n",mySettings.MasterClockToMODLfo);
          }
     break;
     ...
     case 126: // Master Clock To Vol LFO
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Master Clock To Vol LFO to high value: %d\n",value);
          }
          else
          {
            ...
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Master Clock To VOL LFO is set to: %d\n",mySettings.MasterClockToVOLLfo);
          }
     break;

     case 127: // Master Clock To Freq LFO
          if(value >1){
            if(DEBUG_EXPRESSION_PEDAL) Serial.printf("Master Clock To Freq LFO to high value: %d\n",value);
          }
          else
          {
    ...
    default:
       if(DEBUG_EXPRESSION_PEDAL){
        Serial.printf("E_P %d currently not implemented\n",control );
       }       
   }
