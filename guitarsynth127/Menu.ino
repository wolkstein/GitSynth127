...
// SYNTHS
    ...
    case 10 + 49: // MOD LFO waveform
     ...
     case 10 + 127: // Expression Pedal Function
      ...
      my_I_incrementer = updown;
      if(checkIntValuesValide(my_I_incrementer, 0, 27, mySettings.expressionPedalFunction + my_I_incrementer))
     ...
     case 10 + 130: // Poti Function
      ...
      my_I_incrementer = updown;
      if(checkIntValuesValide(my_I_incrementer, 0, 27, mySettings.freeDataInt2 + my_I_incrementer))
